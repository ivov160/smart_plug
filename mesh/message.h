...
void send_keep_alive(struct mesh_ctx* mesh, struct device_info* info); //timer
void send_request_devices_info(struct mesh_ctx* mesh); //oneshoot
void send_device_info(struct mesh_ctx* mesh, struct device_info* info, uint32_t dst); //callback
